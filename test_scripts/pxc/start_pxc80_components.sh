    ...
    cat << EOF > ${BASEDIR}/lib/plugin/component_keyring_kms.cnf
{
 ...
 "region": "us-east-1",
 "kms_key": "a7d4a714-7dad-4ae1-a0fa-0a647c86dcde",
 "auth_key": "AKIARXP3OARBOWBZ4YS6",
 "secret_access_key": "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",
 "read_only": false
}
EOF
  fi
...
wsrep_provider=$BASEDIR1/../../percona-xtradb-cluster-galera/libgalera_smm.so
...
wsrep_provider=$BASEDIR2/../../percona-xtradb-cluster-galera/libgalera_smm.so
...
wsrep_provider=$BASEDIR3/../../percona-xtradb-cluster-galera/libgalera_smm.so
